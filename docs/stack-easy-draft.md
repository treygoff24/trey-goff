# The Job Site (draft v1)

> Content draft for /stack easy mode. Seven beats, one running analogy.
> [Scene] notes describe what the persistent animated site illustration shows at that beat.
> Each beat ends with "On the real site": the actual jargon named once, plus the hard-mode chapter it graduates into.

**Reader:** a smart adult who has never written a line of code, never opened a terminal, and thinks "AI" means the chat box that writes emails. They may run a business, a classroom, or a household. They have hired people before, or at least been hired.
...
*The other version of this page is written for software engineers. This one is written for everyone else. It's the same system, told the way I actually understand it.*

[Toggle: Easy mode ← you are here · Hard mode →]
...
[Footer: Ready for the deep end? → Hard mode, chapter 1. / Built by the crew it describes.]
