...
describe('Home page framer-motion removal', () => {
  it('HolographicTile should not import framer-motion', async () => {
    ...
    assert.ok(!content.includes('motion.'), 'HolographicTile should not use motion components')
    assert.ok(!content.includes('useMotionValue'), 'HolographicTile should not use motion hooks')
    assert.ok(
  ...
  it('SignalGrid should not import framer-motion', async () => {
    ...
    assert.ok(!content.includes('framer-motion'), 'SignalGrid should not import from framer-motion')
  })
})
