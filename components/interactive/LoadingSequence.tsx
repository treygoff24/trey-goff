  ...
  return (
    ...
    >
      ...
      <div className="mb-8 text-center">
        <h1 className="font-satoshi text-3xl font-medium text-text-1">Interactive World</h1>
        <p className="mt-2 text-text-2">{PHASE_MESSAGES[phase]}</p>
      </div>
      ...
      <p className="mt-4 font-mono text-xs text-text-3">{status}</p>
