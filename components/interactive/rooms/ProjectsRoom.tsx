  ...
  return (
    <group position={position}>
      ...
      <mesh position={[0, 0.4, 0]} castShadow>
        ...
        <meshStandardMaterial color="#151520" roughness={0.3} metalness={0.7} />
      </mesh>

      {/* Pedestal column - sleeker */}
      <mesh position={[0, 1, 0]} castShadow>
        <cylinderGeometry args={[0.1, 0.12, 0.8, 16]} />
        <meshStandardMaterial color="#252535" roughness={0.2} metalness={0.8} />
      </mesh>
  ...
  return (
    <group name="room-projects">
      ...
      {!loading && projects.length > 0 && (
        <ProjectExhibits projects={projects} onProjectSelect={handleProjectSelect} />
      )}
      ...
      {!loading && projects.length === 0 && (
        <mesh position={[0, 2, 0]}>
          ...
          <meshBasicMaterial color={THREE_COLORS.accent} transparent opacity={0.3} />
        </mesh>
      )}
      ...
      <group position={[0, 2, ROOM_DEPTH / 2]}>
        <mesh>
          ...
          <meshStandardMaterial color="#1a1520" roughness={0.3} metalness={0.7} />
        </mesh>
        {/* Door frame accent */}
