  ...
  return (
    <group>
      ...
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, 0.01, 0]} receiveShadow>
        ...
        <meshStandardMaterial color={THREE_COLORS.warm} roughness={0.3} metalness={0.7} />
      </mesh>
      ...
      {[-6, 6].map((x) => (
        <mesh key={x} rotation={[-Math.PI / 2, 0, 0]} position={[x, 0.005, 0]} receiveShadow>
  ...
  return (
    <group position={position} rotation={[0, rotation, 0]}>
      ...
      <mesh position={[0, 0, 0.02]}>
        ...
        <meshStandardMaterial color="#252538" roughness={0.6} metalness={0.4} />
      </mesh>
      {/* Inner border */}
  ...
  return (
    <group ref={groupRef} position={[0, HALL_HEIGHT - 1.5, 0]}>
      ...
      <mesh rotation={[Math.PI / 2, 0, 0]}>
        ...
        <meshStandardMaterial color={THREE_COLORS.warm} metalness={0.85} roughness={0.15} />
      </mesh>
      ...
      {Array.from({ length: 8 }).map((_, i) => {
        ...
        return (
          <group key={i} position={[x, -0.4, z]}>
            ...
            <pointLight intensity={0.15} color={THREE_COLORS.warm} distance={4} decay={2} />
          </group>
        )
      })}
  ...
  return (
    <group position={position} rotation={[0, rotation, 0]}>
      ...
      <mesh position={[0, 3, 0.2]}>
        ...
        <meshStandardMaterial color="#0B1020" roughness={0.5} metalness={0.3} />
      </mesh>
      ...
      {pillarPositions.map((pos, i) => (
        <group key={i} position={pos}>
          ...
          <mesh position={[0, 0.15, 0]} castShadow>
            ...
            <meshStandardMaterial color="#2a2a3a" roughness={0.5} metalness={0.5} />
          </mesh>
          ...
          <mesh position={[0, 2, 0]} rotation={[Math.PI / 2, 0, 0]}>
            ...
            <meshStandardMaterial color={THREE_COLORS.warm} metalness={0.8} roughness={0.2} />
          </mesh>
        </group>
      ))}
    </group>
