...
function ONeillCylinder({
  ...
  return (
    <mesh position={position} rotation={[0, 0, Math.PI / 6 + rotation]} scale={scale}>
  ...
  return (
    <group ref={groupRef}>
      {cylinderData.map((data, i) => (
        <ONeillCylinder key={i} position={data.pos} rotation={data.rotation} scale={data.scale} />
      ))}
    </group>
  )
}
    ...
    <group position={[0, 0, -20]}>
      ...
      {[2, 6, 10].map((y) => (
        <mesh key={y} position={[0, y, MANSION_DEPTH / 2 + 0.05]}>
          ...
          <meshStandardMaterial color="#4a4a5a" roughness={0.2} metalness={0.9} />
        </mesh>
      ))}
      ...
      <mesh position={[0, MANSION_HEIGHT + 1.5, 0]} castShadow>
        ...
        <meshStandardMaterial color="#12121a" roughness={0.6} metalness={0.4} />
      </mesh>
        ...
        [3.5, 7.5].map((y) => (
          <group key={`${x}-${y}`} position={[x, y, MANSION_DEPTH / 2]}>
            ...
            <mesh position={[0, 0, 0.05]}>
              ...
              <meshStandardMaterial color="#3a3a4a" roughness={0.3} metalness={0.8} />
            </mesh>
  ...
  return (
    <group ref={groupRef} position={[25, 5, -10]}>
      ...
      <mesh castShadow>
        ...
        <meshStandardMaterial color="#2a2a35" roughness={0.2} metalness={0.9} />
      </mesh>

      {/* Chest plate */}
      <mesh position={[0, 0.5, 2.1]}>
        <boxGeometry args={[4, 4, 0.3]} />
        <meshStandardMaterial color="#3a3a45" roughness={0.1} metalness={0.95} />
      </mesh>
      ...
      <mesh position={[0, 4.5, 0]} castShadow>
        ...
        <meshStandardMaterial color="#1a1a25" roughness={0.2} metalness={0.9} />
      </mesh>

      {/* Head crest */}
      <mesh position={[0, 5.8, 0]}>
        <boxGeometry args={[0.5, 0.8, 2]} />
        <meshStandardMaterial color="#3a3a4a" roughness={0.2} metalness={0.9} />
      </mesh>
      ...
      {[-3.5, 3.5].map((x) => (
        <group key={x} position={[x, 0, 0]}>
          ...
          <mesh position={[0, -1.5, 0]} castShadow>
            ...
            <meshStandardMaterial color="#25252f" roughness={0.25} metalness={0.85} />
          </mesh>
          {/* Lower arm */}
          <mesh position={[0, -4.5, 0]} castShadow>
            <boxGeometry args={[1.5, 3, 1.8]} />
            <meshStandardMaterial color="#1f1f28" roughness={0.2} metalness={0.9} />
          </mesh>
          {/* Hand/fist */}
          <mesh position={[0, -6.5, 0]} castShadow>
            <boxGeometry args={[1.2, 1.2, 1.5]} />
            <meshStandardMaterial color="#2a2a35" roughness={0.3} metalness={0.85} />
          </mesh>
        </group>
      ))}
...
function Ground() {
  ...
  return (
    <group>
      {/* Main ground */}
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, 0, 0]} receiveShadow name="ground">
        <planeGeometry args={[GROUND_SIZE, GROUND_SIZE]} />
        <meshStandardMaterial color="#0a0a15" roughness={0.85} metalness={0.15} />
      </mesh>

      {/* Landing pad - hexagonal feel */}
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, 0.02, 5]} receiveShadow>
        <circleGeometry args={[8, 6]} />
        <meshStandardMaterial color="#15151f" roughness={0.7} metalness={0.3} />
      </mesh>
      ...
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, 0.01, -5]} receiveShadow>
        ...
        <meshStandardMaterial color="#12121a" roughness={0.75} metalness={0.25} />
      </mesh>

      {/* Path edge lines */}
      {[-2.3, 2.3].map((x) => (
        <mesh key={x} rotation={[-Math.PI / 2, 0, 0]} position={[x, 0.02, -5]}>
  ...
  return (
    <group position={[-25, 0, -15]}>
      <mesh position={[0, 3.5, 0]} castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#181820" roughness={0.6} metalness={0.4} />
      </mesh>

      {/* Garage door - with segments */}
      <mesh position={[0, 3, 5.1]}>
        <planeGeometry args={[8, 6]} />
        <meshStandardMaterial color="#101018" roughness={0.5} metalness={0.5} />
      </mesh>
...
export function ExteriorRoom({ debug = false, onDoorActivate }: ExteriorRoomProps) {
  return (
    <group name="room-exterior">
      ...
      <directionalLight position={[-20, 30, 10]} intensity={0.3} color="#ff8866" />
