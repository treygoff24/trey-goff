 ...
 */
function CameraIntegration({ reducedMotion }: { reducedMotion: boolean }) {
...
export function InteractiveWorld({
  ...
  const { isTransitioning, startTransition, TransitionOverlayProps } = useRoomTransition({
    ...
    onSwap: (targetRoom) => {
      ...
      const rotation =
        pendingTransition.current?.spawnRotation ?? getRoomRotation(targetRoom as RoomId)
  ...
  return (
    <KeyboardControls map={keyboardControlsMap}>
      <div className="relative h-full w-full">
        ...
        <TransitionOverlay {...TransitionOverlayProps} reducedMotion={reducedMotion} />
