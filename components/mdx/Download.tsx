  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="font-satoshi font-medium text-text-1 group-hover:text-warm">{displayLabel}</p>
        {size && <p className="text-sm text-text-3">{size}</p>}
      </div>
      <span className="text-sm text-text-3 group-hover:text-warm">Download -&gt;</span>
    </a>
  )
}
