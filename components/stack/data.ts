...
export const CHAPTERS = [
  ...
  { id: 'ch5', n: '05', title: 'The cockpit' },
  { id: 'ch6', n: '06', title: 'Multiplying it' },
  { id: 'ch7', n: '07', title: 'Trusting it at scale' },
...
export const TREE: Record<string, TreeNode> = {
  ...
  feature: {
    ...
    ch: ['#ch7', '07 · Trusting it at scale'],
  },
  pile: {
    kind: 'leaf',
    crumb: 'The pile',
