 ...
 * own JSX on purpose — parameterizing this template far enough to cover them would cost
 * more at the call site than it saves.
 */
...
export function renderSiteOGCard(heading: string): ImageResponse {
