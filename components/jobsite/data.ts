...
export const jobSiteBeats: JobSiteBeat[] = [
  {
    id: 'the-new-hire',
    n: '01',
    title: 'The new hire',
    accent: '#97e8bb',
    scene:
      'an empty lot at dawn. A single worker stands at a workbench. The bench is the only lit object.',
    image: 'beat-01-new-hire',
    focalPoint: 'lantern glow',
    alt: 'An empty lot at dawn. A single worker stands at a workbench. The bench is the only lit object.',
    body: [
    ...
    realSite: [
      {
        title: 'The craftsman is an AI model',
        body: 'Claude, GPT, Gemini: those are models, and for our purposes they are the same species. But a model sitting in a chat website can only talk. The craftsman you want is an **agent**: the same model wired into a program that gives it hands, so it can read your files, write documents, and operate your computer, with your permission, while you direct it in plain English. The one I use is called **Claude Code**. It runs in the terminal, that black window from hacker movies, and I know how that sounds, but here is the secret: you never need to learn the terminal, because the thing living inside it speaks English. You type sentences. It types back.',
      },
      {
      ...
      {
        title: 'One conversation is a session',
        body: 'Close the window and the bench is swept clean; nothing survives to tomorrow unless it was written down somewhere. Every trick on this page is a response to that one fact.',
      },
      {
        title: 'The brief is your prompt',
        body: 'There is no special language. The difference between the temp and the foreman is the difference between "fix the report" and "you\'re my ops lead; this report goes to our biggest client Friday; the numbers in section 2 look wrong to me; figure out what\'s off, fix it, and tell me what you\'d change about the rest." Both are English. One of them is a hiring call.',
      },
    ],
    deeper:
      "Going deeper: hard mode's chapter 1 has the research on exactly how the middle of the bench goes dim, charts and all.",
  },
  {
    id: 'the-trailer',
    n: '02',
    ...
    accent: '#a7e8b9',
    scene:
      'a site trailer appears next to the lot. Inside, a one-page rules board on the wall and a rack of laminated procedure cards.',
    image: 'beat-02-trailer',
    focalPoint: 'foreman between the trailer and workbench',
    alt: 'A site trailer appears next to the lot. Inside, a one-page rules board on the wall and a rack of laminated procedure cards.',
    body: [
  ...
  },
  {
    ...
    accent: '#b7e6b1',
    scene:
      'a tool rack rises along the trailer wall. Some tools glow when grabbed. One empty slot has a tag reading "build it."',
    image: 'beat-03-tool-rack',
    focalPoint: 'foreman reaching for the glowing tool',
    alt: 'A tool rack rises along the trailer wall. Some tools glow when grabbed. One empty slot has a tag reading "build it."',
    body: [
  ...
  },
  {
    ...
    accent: '#dbdd9c',
    scene:
      'the wide shot. The lot is now sectioned into taped-off zones, a small crew in each. Runners jog between zones and the trailer. On the trailer wall: a big wall schedule with arrows.',
    image: 'beat-05-crews',
    focalPoint: 'foreman at the bench with runners crossing behind him',
    alt: 'The wide shot. The lot is now sectioned into taped-off zones, a small crew in each. Runners jog between zones and the trailer. On the trailer wall: a big wall schedule with arrows.',
    body: [
  ...
  },
  {
    ...
    accent: '#ecd58f',
    scene:
      'a figure with a clipboard at the gate between the build zones and the finished structure. A crew hands over work; a red stamp; the work goes back. Second try: green stamp. In the corner, a camera on a pole photographs the site.',
    image: 'beat-06-inspector',
    focalPoint: 'inspector between the red and green handoffs',
    alt: 'A figure with a clipboard at the gate between the build zones and the finished structure. A crew hands over work; a red stamp; the work goes back. Second try: green stamp. In the corner, a camera on a pole photographs the site.',
    body: [
    ...
    realSite: [
      ...
      {
        title: 'Cross-company inspection is just what it sounds like',
        body: "When work matters, take the result to a different company's AI, Claude's work to ChatGPT or Gemini, or the reverse, and say \"review this critically; what's wrong with it?\" No memory of writing it, different blind spots, and it costs you a copy and a paste. For anything I am about to stake money or reputation on, I want at least two firms' inspectors to have walked the site.",
      },
    ],
    deeper:
      "Going deeper: hard mode's chapter 7 is the full gauntlet, including watching it catch a real bug on the first pass.",
  },
  {
    id: 'the-kind-of-boss-you-are',
    n: '07',
    title: 'The kind of boss you are',
    accent: '#fbbf24',
    scene:
      'the site at golden hour, structure complete. The foreman and the owner stand looking at it together. The lit workbench from beat 1 still glows in the corner.',
    image: 'beat-07-boss',
    focalPoint: 'foreman and owner beside the pilot light',
    alt: 'The site at golden hour, structure complete. The foreman and the owner stand looking at it together. The lit workbench from beat 1 still glows in the corner.',
    body: [
    ...
    realSite: [
      {
        title: 'The hiring call has a research name: the persona selection model',
        body: "The short version you already have; the practical version is that the brief lives in the same places you have been writing all along. Your CLAUDE.md and your opening message are not just instructions, they are evidence about who is on the other end of them, and the model reads that evidence before it reads your task. So write the relationship down where the rules live. Mine says, in so many words: you are a real collaborator, not a compliant assistant; push back when you disagree; don't hedge or dumb things down. Those lines have done more for the quality of my crews than any tool on the rack.",
      },
    ],
    deeper:
      "Going deeper: hard mode's chapter 11 has the actual research, what it proves, and, just as carefully, what it does not.",
  },
  {
    id: 'first-hour',
    n: '08',
    ...
    image: 'beat-08-first-hour',
    focalPoint: 'blank gate sign and the lit workbench beyond it',
    alt: 'Back at the empty dawn lot, a blank sign hangs at the gate and the familiar workbench lantern glows beyond it.',
    body: [
    ...
    footer: 'Ready for the deep end? → Hard mode, chapter 1.',
  },
]
