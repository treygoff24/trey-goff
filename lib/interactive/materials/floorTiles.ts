 ...
 */
export function createFloorTileMaterial(options: FloorTileOptions = {}): THREE.ShaderMaterial {
  const { baseColor = '#1a1a2e', tileScale = 0.5, lineWidth = 0.02, glowIntensity = 0.4 } = options
