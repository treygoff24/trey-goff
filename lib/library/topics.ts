...
export const TOPIC_FAMILIES: TopicFamily[] = [
  ...
  },
  {
    ...
    topics: ['philosophy', 'consciousness', 'psychology', 'neuroscience', 'buddhism', 'stoicism', 'meditation', 'existentialism', 'ethics', 'spirituality'],
    color: '#8B5CF6',
  },
  {
    id: 'economics',
    label: 'Economics & Markets',
    topics: ['economics', 'finance', 'investing', 'money', 'venture-capital', 'austrian-economics', 'inequality', 'poverty', 'land'],
    color: '#F59E0B',
  },
  {
    id: 'politics',
    label: 'Politics & Governance',
    topics: ['politics', 'governance', 'government', 'libertarianism', 'classical-liberalism', 'anarchism', 'anarcho-capitalism', 'liberty', 'policy', 'law', 'constitution'],
    color: '#14B8A6',
  },
  {
    id: 'science',
    label: 'Science & Nature',
    topics: ['science', 'physics', 'biology', 'evolution', 'genetics', 'cosmology', 'quantum', 'mathematics', 'math', 'statistics', 'probability', 'geology', 'nature', 'environment', 'climate'],
    color: '#22C55E',
  },
  {
    id: 'technology',
    label: 'Technology & Future',
    topics: ['technology', 'ai', 'innovation', 'future', 'nuclear', 'energy', 'space', 'networks', 'data', 'systems'],
    color: '#3B82F6',
  },
  {
    id: 'business',
    label: 'Business & Startups',
    topics: ['business', 'startups', 'entrepreneurship', 'management', 'leadership', 'marketing', 'growth', 'performance', 'success', 'productivity'],
    color: '#EAB308',
  },
  {
    id: 'history',
    label: 'History & Culture',
    topics: ['history', 'culture', 'war', 'military', 'geopolitics', 'foreign-policy', 'society', 'sociology', 'anthropology', 'linguistics', 'language'],
    color: '#A16207',
  },
  {
    id: 'world',
    label: 'World & Places',
    topics: ['charter-cities', 'singapore', 'china', 'israel', 'ukraine', 'europe', 'anglosphere', 'immigration', 'urban-planning', 'communities', 'local-knowledge'],
    color: '#06B6D4',
  },
  {
    id: 'health',
    label: 'Health & Life',
    topics: ['health', 'fitness', 'longevity', 'relationships', 'marriage', 'parenting', 'dogs', 'lifestyle', 'habits', 'dopamine', 'drugs', 'psychedelics', 'sports'],
    color: '#FB7185',
  },
  {
    id: 'religion',
  ...
  },
  {
    ...
    topics: ['knowledge', 'learning', 'education', 'creativity', 'art', 'journalism', 'negotiation', 'communication', 'social-dynamics', 'memoir', 'biography', 'networking'],
    color: '#F97316',
  },
]
